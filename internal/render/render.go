...
// SetRenderConfig sets the config for the template package
func SetRenderConfig(config *config.AppConfig) {
	appConfig = config
}
...
// Template render templates and writes them to response
